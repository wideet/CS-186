...
public class BNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    /* TODO: Implement me! */
    return (int) (Math.ceil((double) this.getLeftSource().getStats().getNumPages() / (this.numBuffers - 2)) *
              this.getRightSource().getStats().getNumPages() +
              this.getLeftSource().getStats().getNumPages());
  }
