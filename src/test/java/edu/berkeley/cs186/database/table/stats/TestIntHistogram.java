...
public class TestIntHistogram {
  ...
  public void studentTest7() {
    ...
    for (int i = 0; i < 500; i++) {
      histogram.addValue(i%10);
    }

    assertEquals(10, histogram.getNumDistinct());

    IntDataBox value = new IntDataBox(3);
    IntHistogram copyHistogram = histogram.copyWithPredicate(PredicateOperator.EQUALS,
            value);

    assertEquals(50, copyHistogram.getEntriesInRange(0, 500));
  ...
  public void studentTest5() {
    ...
    assertEquals(150, copyHistogram.getEntriesInRange(0, 500));
    assertEquals(3, copyHistogram.getNumDistinct());
  }
