...
public class TestOptimalQueryPlanJoins {
  ...
  public void studentTest3() throws DatabaseException, QueryPlanException {
    Database.Transaction transaction = this.database.beginTransaction();
  ...
  @Test
  @Category(StudentTestP4.class)
  public void studentTest4() throws DatabaseException, QueryPlanException {
    Database.Transaction transaction = this.database.beginTransaction();
    transaction.queryAs(this.defaulTableName, "t1");
    transaction.queryAs(this.defaulTableName, "t2");
  ...
  @Test(timeout=5000)
  @Category(StudentTestP4.class)
  public void studentTest9() throws DatabaseException, QueryPlanException {
    Database.Transaction transaction = this.database.beginTransaction();
    transaction.queryAs(this.defaulTableName, "t1");
    transaction.queryAs(this.defaulTableName, "t2");

    QueryPlan queryPlan = transaction.query("t2");

    queryPlan.join("t1", "t2.string", "t1.string");
